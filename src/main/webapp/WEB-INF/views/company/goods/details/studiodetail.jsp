...
<div class="table_title table_mt">스튜디오 세부내용 등록</div>
				<table class="table_box">
					...
					<tbody>
						...
						<tr>
							<th><label for="r_num">룸 갯수</label></th>

							<td class="td_sec">
								<div class="inputArea r_num">
									<input type="text" id="r_num" name="r_num" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="cam_rent_wh">카메라대여</label></th>

							<td class="td_sec">
								<div class="inputArea cam_rent_wh">
									<input type="text" id="cam_rent_wh" name="cam_rent_wh" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
						...
						<tr>
							<th><label for="lens_rent_wh">렌즈대여</label></th>

							<td class="td_sec">
								<div class="inputArea lens_rent_wh">
									<input type="text" id="lens_rent_wh" name="lens_rent_wh" class="chk" /> <span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="pet_comp_wh">반려동물</label></th>

							<td class="td_sec">
						
								<div class="inputArea pet_comp_wh">
									<input type="text" id="pet_comp_wh" name="pet_comp_wh" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="night_comp_wh">야간촬영</label></th>

							<td class="td_sec">
								<div class="inputArea night_comp_wh">
									<input type="text" id="night_comp_wh" name="night_comp_wh" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
