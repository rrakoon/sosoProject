...
$(document).ready(function(){
   $('input[type = "radio"][name="verify"]').click(function(){
      if($(this).prop('checked')){
         $('input[type = "radio"][name="verify"]').prop('checked',false);
         $(this).prop('checked',true);
      }
   })
})
        ...
        <section class="login">
                ...
                <div class="signup-content">
                    ...
                    <div class="row">
                        <div class="col-sm-6 socials">
                            ...
                            <hr>
                            <a href="https://kauth.kakao.com/oauth/authorize?client_id=50a9be3a49b8a6fa37a35fdad85aae49&redirect_uri=http://localhost:10001/oauth&response_type=code"><img src="/resources/images/register/Kakao.jpg"></a>
            ...
            id="usercheck" name="member">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="verify" name="verify" value="1" checked/><span class="vt_align">일반</span>
                                <input type="radio" id="verify" name="verify" value="0" /><span class="vt_align">사업자</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="gender" name="gender" value="남"><span class="vt_align">남</span>
                                <input type="radio" id="gender" name="gender" value="여" checked><span class="vt_align">여</span>
                            </div>
